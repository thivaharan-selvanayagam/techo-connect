      ...
      <section style={{ padding: '4rem 0 6rem', background: 'white' }}>
        <div className="container-sm">
          ...
          <div className="desktop-only">
            ...
            {/* Related policies links on desktop layout viewports */}
          ...
          <div className="mobile-only">
            <div>
              <MobileSection num="1" title="Information We Collect">
                <p style={{ marginBottom: '0.5rem' }}>When you place an order or contact us, we collect the following personal information:</p>
              ...
              <MobileSection num="2" title="How We Use Your Information">
                <p style={{ marginBottom: '0.5rem' }}>Your personal information is used solely for:</p>
                <ul style={{ paddingLeft: '1.2rem', marginBottom: '0.5rem' }}>
                  <li>Processing and fulfilling your order</li>
                  <li>Communicating delivery status and updates via WhatsApp or phone</li>
                  <li>Handling warranty claims and return requests</li>
              ...
              <MobileSection num="3" title="Data Storage & Security">
                <p style={{ marginBottom: '0.5rem' }}>Your order data is securely stored in <strong>Supabase</strong>, a cloud database platform with industry-standard encryption. Payment receipts are stored in an encrypted cloud storage bucket with restricted access.</p>
              ...
              <MobileSection num="4" title="Third-Party Services">
                <p style={{ marginBottom: '0.5rem' }}>We use the following third-party services which may process your data as part of our operations:</p>
                <ul style={{ paddingLeft: '1.2rem', marginBottom: '0.5rem' }}>
                  <li><strong>Supabase</strong> — order database and file storage</li>
                  <li><strong>WhatsApp (Meta)</strong> — customer communication and order notifications</li>
                  <li><strong>Vercel</strong> — website hosting</li>
              ...
              <MobileSection num="5" title="Data Retention">
                <p style={{ marginBottom: '0.5rem' }}>We retain your order data for a minimum of <strong>2 years</strong> for warranty and dispute resolution purposes. After this period, data may be anonymised or deleted.</p>
                <p>You may request deletion of your personal data at any time by contacting us via WhatsApp or email, subject to any legal or operational retention requirements.</p>
              </MobileSection>

              <MobileSection num="6" title="Your Rights">
              ...
              <MobileSection num="7" title="Cookies">
                <p>Our website uses essential cookies for functionality (e.g., maintaining your shopping cart) and optional analytics cookies to understand website usage. You can manage cookie preferences through your browser settings.</p>
              </MobileSection>

              <MobileSection num="8" title="Children's Privacy">
                <p>Our website and products are not directed at children under 13 years of age. We do not knowingly collect personal information from children. If you believe a child has provided us with personal information, please contact us immediately.</p>
              </MobileSection>

              <MobileSection num="9" title="Changes to This Policy">
                <p>We may update this Privacy Policy periodically. The "Last Updated" date at the top of this page reflects the most recent revision. Continued use of our website after changes constitutes acceptance of the updated policy.</p>
              </MobileSection>

              <MobileSection num="10" title="Contact Us">
                <p>For any privacy-related questions or requests:</p>
