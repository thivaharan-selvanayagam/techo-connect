...
export const metadata = {
  ...
  description: 'Techo Connect delivery charges, timelines, and shipping information for all Sri Lanka districts.',
}
        ...
        <div className="container-sm">
          ...
          <div style={{ background: 'var(--bg)', border: '1px solid var(--border-light)', borderRadius: 16, padding: '2rem', textAlign: 'center', marginTop: '2rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <a href={`${WA_LINK}${encodeURIComponent('Hello! I have a question about my Techo Connect delivery.')}`} target="_blank" rel="noopener" className="btn btn-wa">
                WhatsApp +94 70 665 6007
              </a>
              <Link href="/contact" className="btn btn-outline">Contact Page</Link>
            </div>
          </div>
